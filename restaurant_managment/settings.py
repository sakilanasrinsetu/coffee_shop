...
#SECRET_KEY = 'django-insecure-qd*^qzw^zt4#*-f1-ym*!()oqf8o9s4%(bn)ip8q7xa_0m^%7n'
...
GRAPH_MODELS = {
  'all_applications': True,
  'group_models': True,
  'app_labels': ["accounts", "cafe", "dashboard", "auth"],
}
...
REST_KNOX = {
    'TOKEN_TTL': timedelta(hours=8760), # Token valid For 1 Year
}
